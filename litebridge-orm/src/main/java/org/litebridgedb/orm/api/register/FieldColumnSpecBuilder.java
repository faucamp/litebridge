 ...
 * and database expressions. This class is part of the fluent API for creating field-to-lhs mapping
 ...
 * structures, including basic field-lhs mappings, property-based mappings, and advanced relations
 ...
 * stage in defining the field-lhs specification. The result of the configuration is encapsulated
 ...
 *  <li>Subsequent methods allow specifying database lhs names, or defining relationships
...
public final class FieldColumnSpecBuilder {
    ...
    /**
     * Maps a specific field in a DTO to begin the configuration process for defining its database lhs mapping.
     * This is the initial step of the field-to-lhs mapping process using the builder.
     *
     ...
     * to its corresponding database lhs or table specification.
     *
     ...
     *           of steps required to configure the field-to-lhs mapping.
     * @return A {@link FieldColumnSpec} representing the finalised mapping between the DTO field
     * or property and the database lhs or table specification.
     */
