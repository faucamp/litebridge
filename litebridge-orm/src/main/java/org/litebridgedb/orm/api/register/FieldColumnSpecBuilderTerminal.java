...
/**
 * A terminal step in the fluent API for configuring field-to-database-lhs mappings within
 * an Object-Relational Mapping (ORM) system. This sealed interface represents the final stage
 * in the configuration process, marking the completion of the specification for a database lhs
 * or join condition associated with a field.
 * <p>
 * This interface is part of a step-by-step builder pattern, ensuring that field-to-lhs
