...
public class SqlDeleteWhereConditionClause
    ...
    public SqlDeleteWhereConditionClause(final ConditionSpec conditionSpec,
                                         final LitebridgeContext litebridgeContext,
                                         final LogicOperator logicOperator,
                                         final ExpressionSpec lhs,
                                         final java.util.function.Function<org.litebridge.orm.api.select.ast.QueryNode, SqlDeleteWhereConditionClauseTerminal> terminalRecreator) {
