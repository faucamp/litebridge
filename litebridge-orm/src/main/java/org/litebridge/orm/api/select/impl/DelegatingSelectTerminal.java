...
public class DelegatingSelectTerminal<DTO> implements SelectTerminal<DTO> {

    private final SelectTerminal<DTO> delegate;

    public DelegatingSelectTerminal(final SelectTerminal<DTO> delegate) {
