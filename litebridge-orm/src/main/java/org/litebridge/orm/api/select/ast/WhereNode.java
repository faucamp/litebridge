 ...
 */
public record WhereNode(@Nullable QueryNode previous, LogicOperator logicOperator, ExpressionSpec lhs, Operator operator, @Nullable Object rhs) implements QueryNode {
}
