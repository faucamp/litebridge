...
//                new WhereNode(null, null)
//        );
//        final DtoWhereConditionClauseTerminal<String> terminal = new DtoWhereConditionClauseTerminal<>(selector);
//
//        // When
//        final DtoWhereConditionClauseTerminal<String> result = terminal.and(q -> {
...
//
//        // When
//        final DtoWhereConditionClauseTerminal<String> result = terminal.or(q -> {
//            return new CbDtoConditionClauseTerminal<>(ormTable, mock(org.litebridge.orm.engine.FromClauseEngine.class), null);
//        });
//
//        // Then
