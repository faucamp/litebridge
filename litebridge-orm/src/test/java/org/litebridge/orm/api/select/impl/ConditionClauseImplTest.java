...
//        clause = new ConditionClauseImpl<>(mock(LitebridgeContext.class), LogicOperator.NOOP, new org.litebridge.orm.expression.select.SelectColumnSpec(mock(org.litebridge.db.spi.Column.class)), null, n -> mock(TestConditionClauseTerminal.class));
//    }
//
//    @Test
//    void eq() {
