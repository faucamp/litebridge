...
class AnnotationMapperTest {
    ...
    void createDtoTableSpec_RecordStyle() {
        ...
        assertEquals(1, spec.tableSpec().fieldColumnMap().size());
        assertTrue(spec.tableSpec().fieldColumnMap().keySet().stream().anyMatch(f -> ((org.litebridge.orm.api.spec.FieldSpec) f).name().equals("name")));
    }
    ...
    void createDtoTableSpec_ShortGet() {
        ...
        assertEquals(1, spec.tableSpec().fieldColumnMap().size());
        assertTrue(spec.tableSpec().fieldColumnMap().keySet().stream().anyMatch(f -> ((org.litebridge.orm.api.spec.FieldSpec) f).name().equals("get")));
    }
