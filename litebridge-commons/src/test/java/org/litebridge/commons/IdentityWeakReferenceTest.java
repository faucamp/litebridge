...
class IdentityWeakReferenceTest {
    ...
    void testEquals_sameObject() {
        ...
        final WeakIdentityHashMap.IdentityWeakReference<Object> ref1 = new WeakIdentityHashMap.IdentityWeakReference<>(referent, queue);
        final WeakIdentityHashMap.IdentityWeakReference<Object> ref2 = new WeakIdentityHashMap.IdentityWeakReference<>(referent, queue);
    ...
    void testEquals_differentObjects() {
        ...
        final ReferenceQueue<Object> queue = new ReferenceQueue<>();
        final WeakIdentityHashMap.IdentityWeakReference<Object> ref1 = new WeakIdentityHashMap.IdentityWeakReference<>(referent1, queue);
        final WeakIdentityHashMap.IdentityWeakReference<Object> ref2 = new WeakIdentityHashMap.IdentityWeakReference<>(referent2, queue);
    ...
    void testEquals_bothReferencesNull() {
        // Given
        final ReferenceQueue<Object> queue = new ReferenceQueue<>();
        final WeakIdentityHashMap.IdentityWeakReference<Object> ref1 = new WeakIdentityHashMap.IdentityWeakReference<>(null, queue);
        final WeakIdentityHashMap.IdentityWeakReference<Object> ref2 = new WeakIdentityHashMap.IdentityWeakReference<>(null, queue);
    ...
    void testEquals_differentClass() {
        ...
        final Object referent = new Object();
        final ReferenceQueue<Object> queue = new ReferenceQueue<>();
        final WeakIdentityHashMap.IdentityWeakReference<Object> ref = new WeakIdentityHashMap.IdentityWeakReference<>(referent, queue);
    ...
    void testHashCode_withNullReferent() {
        // Given
        final ReferenceQueue<Object> queue = new ReferenceQueue<>();
        final WeakIdentityHashMap.IdentityWeakReference<Object> ref = new WeakIdentityHashMap.IdentityWeakReference<>(null, queue);
