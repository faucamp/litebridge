...
class LitebridgeSpringBoot3AutoConfigurationTest {
    ...
    void autoConfigure_configDatabaseProvider_noConstructor() {
        this.contextRunner
                .withPropertyValues("litebridgedb.database-provider.class=org.litebridgedb.spring.boot3.test.LitebridgeSpringBoot3AutoConfigurationTest$NoConstructorDatabaseProvider")
                .run(context -> {
