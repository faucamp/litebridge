...
class LitebridgeAutoConfigurationTest {
    ...
    void autoConfigure_configDatabaseProvider_noConstructor() {
        this.contextRunner
                .withPropertyValues("litebridge.database-provider.class=org.litebridgedb.spring.boot.autoconfigure.LitebridgeAutoConfigurationTest$NoConstructorDatabaseProvider")
                .run(context -> {
