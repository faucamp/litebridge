...
public class LitebridgeTransactionManager extends DataSourceTransactionManager implements TransactionManager {
    ...
    @Override
    public void begin() throws org.litebridgedb.db.spi.tx.TransactionException {
    ...
    @Override
    public void begin(final boolean readOnly, final Isolation isolation) throws org.litebridgedb.db.spi.tx.TransactionException {
        throw new UnsupportedOperationException("LitebridgeTransactionManager does not support direct begin(). Use Spring's transaction management (e.g., @Transactional).");
    }

    @Override
    public void cleanup() throws org.litebridgedb.db.spi.tx.TransactionException {
    ...
    @Override
    public void commit() throws org.litebridgedb.db.spi.tx.TransactionException, IllegalStateException {
    ...
    @Override
    public void rollback() throws org.litebridgedb.db.spi.tx.TransactionException, IllegalStateException {
