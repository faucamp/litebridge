...
class OracleColumnIdentifierGeneratorTest {
    ...
    void createSelectColumn_withNonSelectClauseType_doesNotAddAlias() {
        ...
        final Table table = new Table("TEST_TABLE", null);
        final Column column = new Column(table, "TEST_COLUMN", "MY_ALIAS");
        final Select select = new Select(table, Collections.emptyList(), Collections.emptyList(), null, Collections.emptyList(), null, Collections.emptyList(), null);
    ...
    void createColumnRef_withAliasedColumnAndNonWhereClause_returnsAlias() {
        ...
        final Table table = new Table("TEST_TABLE", null);
        final Column column = new Column(table, "TEST_COLUMN", "MY_ALIAS");
        final Operation operation = new Select(table, Collections.emptyList(), Collections.emptyList(), null, Collections.emptyList(), null, Collections.emptyList(), null);
