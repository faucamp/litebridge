...
//
///**
// * Simple direct field access {@code FieldAccessor} implementation.
// * <p>
// * Provides functionality for accessing and manipulating fields of a data transfer object (DTO) directly
// * using only the Java Reflection API (no MethodHandle/VarHandle support).
// * <p>
...
// *
// * @see VarHandleAccessor
// */
//public class RawFieldAccessor implements FieldAccessor {
//
//    private final Field field;
//
//    public RawFieldAccessor(final Field field) {
...
//        if (!(o instanceof final RawFieldAccessor that)) return false;
