...
create table LB.OS_GROUP_EUREKA
(
    EUREKA_ID   VARCHAR2(100) NOT NULL PRIMARY KEY,
    GROUP_ID    VARCHAR2(100) NOT NULL REFERENCES LB.OS_GROUP (GROUP_ID),
    EUREKA_ZONE VARCHAR2(100) DEFAULT 'defaultZone',
    EUREKA_URL  VARCHAR2(255) NOT NULL
);
